...
if(Sys.getenv("GITHUB_ACTIONS") == ""){
  ...
  py_install("pandas", envname = "r-arrow-dash")
  py_install("itables", envname = "r-arrow-dash")
  py_install("plotly", envname = "r-arrow-dash")
  py_install("requests", envname = "r-arrow-dash")
